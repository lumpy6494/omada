...
class Omada:
	...
	## Current API path.
	##
	def get_omadacId(self):
		result = self.session.get(f"{self.baseurl}api/info")
		result = result.json()
		return result["result"]["omadacId"]
	...
	def url_for(self, path):
		# print(self.baseurl + Omada.get_omadacId(self) +Omada.ApiPath + path)
		return self.baseurl + Omada.get_omadacId(self) +Omada.ApiPath + path
